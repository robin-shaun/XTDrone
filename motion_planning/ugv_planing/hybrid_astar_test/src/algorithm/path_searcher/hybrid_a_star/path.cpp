...
//    std::cout << "Constants::length : " << Constants::length << std::endl;
//    std::cout << "Constants::width : " << Constants::width << std::endl;
//    std::cout << "Constants::bloating : " << Constants::bloating << std::endl;
    ...
    if(pathVehicle.pose.position.x == 0 && pathVehicle.pose.position.y == 0)
        return;
